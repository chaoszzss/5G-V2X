...
@ -isysroot /opt/fsl-imx-x11/4.1.15-2.1.0/sysroots/cortexa9hf-neon-poky-linux-gnueabi
...
@ arch/arm/lib/asm-offsets.c -march=armv7-a -mfpu=neon -mfloat-abi=hard
@ -mcpu=cortex-a9 -marm -mno-thumb-interwork -mabi=aapcs-linux
@ -mword-relocations -mno-unaligned-access -march=armv7-a -mtls-dialect=gnu
...
.LASF57:
	.ascii	"GNU C11 5.3.0 -march=armv7-a -mfpu=neon -mfloat-abi"
	.ascii	"=hard -mcpu=cortex-a9 -marm -mno-thumb-interwork -m"
	.ascii	"abi=aapcs-linux -mword-relocations -mno-unaligned-a"
	.ascii	"ccess -march=armv7-a -mtls-dialect=gnu -g -Os -fno-"
...
.LASF59:
	.ascii	"/home/lwj/u-boot-2016.03-r0\000"
.LASF1:
